...
const INITIAL_STATE = { data: [], isLoading: false, error: '', userWantsToSeeFeed: false, postTypeDisplayed: 'Look' }

export default (state = INITIAL_STATE, action) => {
  switch(action.type){
    case types.OPEN_FEED:
      return { ...state, userWantsToSeeFeed: true }
    case types.CHANGE_POST_TYPE_DISPLAYED:
      return { ...state, postTypeDisplayed: action.payload }
    case types.GET_FEED:
