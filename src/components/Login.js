...
import { View, Text, Dimensions, ActivityIndicator, Modal, Alert, Image, TouchableWithoutFeedback, KeyboardAvoidingView, ScrollView } from 'react-native'
  ...
  render = () => {
    return (
      <Container>
        ...
        <Header style={{ backgroundColor: '#5B0E32', height: 70, paddingTop: 20 }}>
          <Body style={{ alignItems: 'center' }}>
            <Text style={{ color: '#FFF', fontSize: 16, fontWeight: 'bold' }}>LOGIN</Text>
          </Body>
        </Header>

        <View style={{ backgroundColor: '#F8F8F8', height: height - 70 }}>

          <View style={{ width, height: (width > 600) ? 380 : 185, alignItems: 'center', justifyContent: 'center'  }}>
            <Image source={LOGO} style={{ backgroundColor: 'white', width: '100%' , height: '100%' }} />
          </View>
          ...
          <View style={{ width, height: height * 0.25, alignItems: 'center' }}>
            ...
            <View style={{ flexDirection: 'row' }}>
              <Text style={{ fontSize: width > 600 ? 16 : 12, marginBottom: 18 }}>Don't have an Account?</Text>
                <TouchableWithoutFeedback onPress={() => Actions.signup()}>
                  <View>
                    <Text style={{ fontSize: width > 600 ? 16 : 12 }}>
                      <Text style={{color: '#5B0E32', fontWeight: 'bold', textDecorationLine: 'underline', fontSize: width > 600 ? 16 : 12 }}> Click Here </Text>
                      to Sign Up
                    </Text>
                  </View>
                </TouchableWithoutFeedback>
