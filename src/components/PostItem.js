...
class PostItem extends Component {
  ...
  renderLikeButton = (isLiked, post) => {
    ...
    return isLiked
      ?
      <Image
        style={{width: width > 600 ? 45 : 30, height: width > 600 ? 45 : 30, borderRadius: width > 600 ? 45/2 : 30/2, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center'      }}
